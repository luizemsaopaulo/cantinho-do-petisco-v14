...
begin
    ...
    loop
        ...
        -- Desativa opções antigas do grupo e reativa apenas a lista V18.
...
-- preço para a opção Carne. O painel V18 já permite configurar esse grupo
