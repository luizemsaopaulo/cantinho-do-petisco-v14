(()=>{
  ...
  const DELIVERY_URL = BASE + '?v=17';
  const RESTAURANT_URL = BASE + 'restaurante.html?v=17';
  ...
  function qr(mode){
    ...
    $('qrDialogImage').src = delivery ? 'assets/qr-delivery-v17.png' : 'assets/qr-restaurante-v17.png';
  ...
  if('serviceWorker' in navigator){
    addEventListener('load', ()=>navigator.serviceWorker.register('service-worker.js?v=17',{scope:'./'}).catch(()=>{}));
  }
